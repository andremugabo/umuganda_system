...
public class DataSeeder {
    ...
    private void seedUsers() {
        ...
        seedUser("Alice",     "Uwamahoro",  "auwamahoro@umuganda.rw",  "0780100002", ERole.VILLAGE_CHEF,   "RW-01-01-01-02", defaultPassword);
        seedUser("Emmanuel",  "Nshimiyimana","enshimi@umuganda.rw",    "0780100003", ERole.VILLAGE_CHEF,   "RW-01-01-02-01", defaultPassword);
        seedUser("Marie",     "Uwizeyimana","muwizey@umuganda.rw",     "0780100004", ERole.VILLAGE_CHEF,   "RW-01-03-01-02", defaultPassword);
        seedUser("Patrick",   "Habimana",   "phabimana@umuganda.rw",   "0780100005", ERole.VILLAGE_CHEF,   "RW-03-04-01-01", defaultPassword);
        seedUser("Claudine",  "Mukamana",   "cmukamana@umuganda.rw",   "0780100006", ERole.VILLAGE_CHEF,   "RW-04-02-01-01", defaultPassword);

        // ── VILLAGE SOCIALS ──
        seedUser("Ange",      "Ingabire",   "aingabire@umuganda.rw",   "0780200001", ERole.VILLAGE_SOCIAL, "RW-01-01-01-01", defaultPassword);
        seedUser("Didier",    "Nzeyimana",  "dnzeyimana@umuganda.rw",  "0780200002", ERole.VILLAGE_SOCIAL, "RW-01-01-01-02", defaultPassword);
        seedUser("Jeanne",    "Dufatanye",  "jdufatanye@umuganda.rw",  "0780200003", ERole.VILLAGE_SOCIAL, "RW-01-01-02-01", defaultPassword);
        seedUser("Innocent",  "Ndayishimiye","indayi@umuganda.rw",     "0780200004", ERole.VILLAGE_SOCIAL, "RW-03-04-01-01", defaultPassword);

        // ── VILLAGERS ──
        seedUser("Alain",     "Mugisha",    "amugisha@umuganda.rw",    "0780300001", ERole.VILLAGER,       "RW-01-01-01-01-01", defaultPassword);
        seedUser("Chantal",   "Uwera",      "cuwera@umuganda.rw",      "0780300002", ERole.VILLAGER,       "RW-01-01-01-01-02", defaultPassword);
        seedUser("Eric",      "Hakizimana", "ehakizi@umuganda.rw",     "0780300003", ERole.VILLAGER,       "RW-01-01-01-02-01", defaultPassword);
        seedUser("Fatuma",    "Niyonzima",  "fniyonzima@umuganda.rw",  "0780300004", ERole.VILLAGER,       "RW-01-01-01-02-02", defaultPassword);
        seedUser("Gaspard",   "Sendanyoye", "gsendanyoye@umuganda.rw", "0780300005", ERole.VILLAGER,       "RW-01-01-02-01-01", defaultPassword);
        seedUser("Honorine",  "Mukagasana", "hmukagasana@umuganda.rw", "0780300006", ERole.VILLAGER,       "RW-01-01-02-01-02", defaultPassword);
        seedUser("Ibrahim",   "Bakundukize","ibakundu@umuganda.rw",    "0780300007", ERole.VILLAGER,       "RW-01-03-01-02-01", defaultPassword);
        seedUser("Joséphine", "Nkurunziza", "jnkurunziza@umuganda.rw", "0780300008", ERole.VILLAGER,       "RW-01-03-01-02-02", defaultPassword);
        seedUser("Kevin",     "Rudahunga",  "krudahunga@umuganda.rw",  "0780300009", ERole.VILLAGER,       "RW-03-04-01-01-01", defaultPassword);
        seedUser("Laetitia",  "Musabyimana","lmusabyimana@umuganda.rw","0780300010", ERole.VILLAGER,       "RW-03-04-01-01-02", defaultPassword);
        seedUser("Marcel",    "Niyonsenga", "mniyonsenga@umuganda.rw", "0780300011", ERole.VILLAGER,       "RW-04-02-01-01-01", defaultPassword);
        seedUser("Nadine",    "Uwimana",    "nuwimana@umuganda.rw",    "0780300012", ERole.VILLAGER,       "RW-04-02-01-01-02", defaultPassword);
